...
const NameCard1 = ({ className = "" }) => {
  return (
    <div
      className={`w-[16.25rem] shadow-[0px_4px_13.6px_-4px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-gray-white overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[0.687rem] px-[0.625rem] pb-[0.75rem] box-border text-center text-[0.875rem] text-dimgray font-body-regular-400 ${className}`}
    >
      <div className="flex-1 overflow-hidden flex flex-col items-start justify-start pt-[0.812rem] px-[1.437rem] pb-[0.562rem] gap-[0.843rem]">
        <div className="flex flex-row items-start justify-start py-[0rem] pl-[3.312rem] pr-[3.375rem]">
          <img
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-[0rem] px-[1.687rem]">
          <button className="cursor-pointer [border:none] pt-[0.562rem] pb-[0.437rem] pl-[2.625rem] pr-[2.562rem] bg-lavender-200 flex-1 rounded-3xs overflow-hidden flex flex-row items-start justify-start hover:bg-lightsteelblue-100">
            <div className="flex-1 relative text-[0.875rem] leading-[1.25rem] font-body-regular-400 text-blue text-center">
              View
            </div>
          </button>
        </div>
